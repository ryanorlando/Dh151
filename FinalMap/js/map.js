...
let geojsonPath = 'data/worldcopy.json';
let geojson_data;
let geojson_layer;
let fieldtomap;
...
function getGeoJSON(){
	...
	$.getJSON(geojsonPath,function(data){
		...
		mapGeoJSON('latest_value',5,'YlOrRd','quantiles')
		//,5,'YlOrRd','quantiles'
	})
}
...
function createDashboard(properties){
	...
	// chart title
	let title = 'Latest Emissions Rate (in KG of CO2 Emitted per Unit of GDP) in ' + properties['geoAreaName'];

	// data values
	let data = [properties['latest_value'], 0.24856];

	// data fields
	let fields = [properties ['geoAreaName'], 'Global Average'];
